    ...
    <div class="container">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            <a href="javascript:;">尊敬的：<%=((Administer)session.getAttribute("admin")).getAdministername()%></a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','/employee/add?id=<%=((Administer)session.getAttribute("admin")).getAdministername()%>')">个人信息</a></dd>
              <%-- <dd><a onclick="x_admin_show('购物车','${ctx }/mall/cart')">购物车</a></dd> --%>
              <dd><a onclick="x_admin_show('切换帐号','/user/logout')">切换帐号</a></dd>
