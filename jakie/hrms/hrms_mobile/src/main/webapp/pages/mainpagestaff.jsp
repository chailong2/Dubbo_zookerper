...
<div class="app">
    ...
    <div class="top-header">
        ...
        <span class="center">工号为<%=session.getAttribute("staff")%>的员工你好！</span>
    ...
    <div class="contentBox" style="background: #8c939d">
        <div class="list-column2">
            <ul class="list">
                <li class="type-item">
                    <a href="/pages/setmeal.jsp" class="link-page">
                ...
                <li class="type-item">
                    <a href="/pages/setmeal2.jsp" class="link-page">
                        <div class="type-title">
                            <h3>修改信息</h3>
                            <p>修改个人信息</p>
                        </div>
                ...
                <li class="type-item">
                    <a href="/pages/setmeal3.jsp" class="link-page">
                        <div class="type-title">
                            <h3>工资查询</h3>
                            <p>本月工资</p>
                        </div>
                ...
                <li class="type-item">
                    <a href="/pages/setmeal4.jsp" class="link-page">
                        <div class="type-title">
                            <h3>今日打卡</h3>
                            <p>签到打卡</p>
                        </div>
